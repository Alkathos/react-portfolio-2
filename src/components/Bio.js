          ...
          <div className='container'>
            <div className='row'>
              ...
              <div className='col center-content'>
                <p>
                    Junior Web Developer that is looking to learn new techniques and use creative solutions for modern day problems.
                    Recived a certificate in Full Stack from University of Miami. My major strength lies in working in teams.
